...
updated: 2020-11-15
---
当記事は2008-04-12に[投稿されたもの](https://npnl.hatenablog.jp/entry/20080412/1207965105)を加筆修正し、再掲したものです。
...
バインドメカニズム(バインド機構)、準備済みSQL文、プリペアードステートメント、パラメータクエリ(クエリの一部が変数のようになっており、その部分は実行時にバインドするクエリ)、ストアドプロシージャとも呼ばれます。  
