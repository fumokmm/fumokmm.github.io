...
updated: 2021-12-29
---
こちらはプログラミング逆引きのメモになります。

{% comment %} ----- グループを取得 ----- {% endcomment %}
{% assign sub_category = site.data.it_sub_category | where: "sub_category_id", "reverse_resolution" | first %}
...
{% assign list = site.it_articles  | where: 'category_id', 'it'
                                   | where: 'sub_category_id', 'reverse_resolution'
                                   | sort: 'display_order' %}
